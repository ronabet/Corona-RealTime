...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _environments_config_dev__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    DialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function DialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DialogComponent_Template_button_click_1_listener() {
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 0,
      consts: [[1, "header-wrapper"], ["src", "../../assets/icon.svg", "id", "tommy-logo"], ["id", "corona-title"], ["id", "home", 3, "click"], ["id", "info", 3, "click"], ["id", "symp", 3, "click"], ["id", "protect", 3, "click"], ["id", "qa", 3, "click"]],
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function HomeComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_7_Template_div_click_0_listener() {
    ...
    function () {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function getAllCountries() {
          ...
          this.api.getAllCountriesStat().subscribe(function (res) {
            _this2.ResStat = res.countryitems["0"];
            Object.keys(_this2.ResStat).forEach(function (element) {
              _this2.AllCountriesArray.push({
                "title": _this2.ResStat[element].title,
                "total_cases": _this2.ResStat[element].total_cases,
                "total_recovered": _this2.ResStat[element].total_recovered,
                "total_deaths": _this2.ResStat[element].total_deaths,
                "total_new_cases_today": _this2.ResStat[element].total_new_cases_today,
                "total_new_deaths_today": _this2.ResStat[element].total_new_deaths_today,
                "total_serious_cases": _this2.ResStat[element].total_serious_cases
              });
            });
        ...
        value: function getIsrael() {
          ...
          this.api.getAllCountriesStat().subscribe(function (res) {
            _this3.ResStat = res.countryitems;
            var index = 76;

            _this3.StatsArray.push({
              "title": _this3.ResStat["0"][index].title,
              "total_cases": _this3.ResStat["0"][index].total_cases,
              "total_recovered": _this3.ResStat["0"][index].total_recovered,
              "total_deaths": _this3.ResStat["0"][index].total_deaths,
              "total_new_cases_today": _this3.ResStat["0"][index].total_new_cases_today,
              "total_new_deaths_today": _this3.ResStat["0"][index].total_new_deaths_today,
              "total_serious_cases": _this3.ResStat["0"][index].total_serious_cases
            });

            console.log(_this3.StatsArray);
          });
        }
      }, {
        ...
        value: function addTasksToDisplay(countriesStats) {
          ...
          countriesStats.forEach(function (AllCountriesArray) {
            if (AllCountriesArray.title.match(_this4.searchText)) {
              _this4.StatsToDisplay.push(AllCountriesArray);
            }
          });
        }
      }, {
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 2,
      consts: [["id", "title"], [4, "ngFor", "ngForOf"], ["id", "worldtitle"], [3, "textChanged"], [1, "container2"], ["class", "card", 3, "click", 4, "ngFor", "ngForOf"], [1, "israelCard"], ["id", "IsraelTitle"], [1, "grid-container"], ["id", "casesIL"], ["id", "deathsIL"], ["id", "otherIL"], [1, "card", 3, "click"], ["id", "countryName"], [1, "centertxt"], ["id", "totalCases"]],
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("textChanged", function HomeComponent_Template_app_search_bar_textChanged_5_listener($event) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\RonNabet\Desktop\Corona\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
